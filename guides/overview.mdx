...
DollarPe provides a comprehensive suite of APIs that enable businesses to offer cryptocurrency-to-fiat payout services to their customers. Our platform handles the complex aspects of cryptocurrency transactions, KYC verification, and banking operations, allowing you to focus on your core business while offering seamless payout solutions.

<Note>
**Partner Integration Benefits:**
- Offer crypto-to-fiat payouts without building blockchain infrastructure
- Leverage our compliant KYC and banking relationships
- Access competitive exchange rates and low transaction fees
- Provide your customers with fast, reliable payment options
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Fiat Payment Methods" icon="money-bill-transfer" href="/guides/support/fiatMethods">
    Explore the available fiat payout options you can offer to your customers.
  </Card>
</CardGroup>
...
<Tabs>
  <Tab title="Cryptocurrency Processing">
    We handle all aspects of cryptocurrency transactions:
    
    - **USDT**: Support on Ethereum, Polygon, Arbitrum, Tron, and Solana networks
    - **USDC**: Support on Ethereum, Polygon, Arbitrum, Tron, and Solana networks
    - Secure wallet infrastructure
    - Transaction monitoring and verification
    - Competitive exchange rates
    
    See [Stablecoins & Blockchains](/guides/support/stablecoins_and_blockchains) for details.
  </Tab>
  
  <Tab title="Fiat Payout Options">
    We provide multiple payout methods to Indian bank accounts:
    
    - **UPI**: Instant transfers up to ₹1,00,000
    - **IMPS**: Instant transfers up to ₹5,00,000
    - **NEFT**: Transfers with no upper limit (approximately 30 minutes processing time)
    - **RTGS**: High-value transfers (min ₹2,00,000)
    
    See [Fiat Payment Methods](/guides/support/fiatMethods) for details.
  </Tab>
  ...
  <Tab title="Compliance & Security">
    ...
    Currently supporting **India** with plans for expansion.
    
    See [Supported Geographies](/guides/support/geographies) for details.
  </Tab>
</Tabs>