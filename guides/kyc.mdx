...
flowchart TD
    ...
    %% PAN Verification Path
    CheckReason -->|PAN Verification Failed| UpdateTax[Update Tax Info]
...
sequenceDiagram
    ...
    else PAN Verification Failed
        KYCSystem-->>API: PAN Verification Failed
...
If PAN verification fails, update tax information using [Update Tax Info](/api-reference/endpoint/kyc/update-tax-info):
