...
<CardGroup cols={3}>
  ...
  <Card title="KYC API" icon="id-card" href="/api-reference-other/endpoint/kyc/add-kyc-data">
    Handle customer verification and compliance processes.
  </Card>
  <Card title="Bank API" icon="building-columns" href="/api-reference-other/endpoint/bank/add-account">
...
<Steps>
  ...
  <Step title="Set Up Authentication">
    Implement our [authentication system](/api-reference-other/overview/authentication) to secure your API requests.
  </Step>
  <Step title="Configure Webhooks">
    Set up a publicly accessible HTTPS endpoint to receive real-time transaction updates via our [webhook system](/api-reference-other/endpoint/organizations/api-webhooks).
  </Step>
</Steps>
...
For detailed instructions on generating these headers, see our [Authentication Guide](/api-reference-other/overview/authentication).
