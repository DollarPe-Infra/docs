...
| `PROCESSING` | Customer's KYC verification is being processed |
...
## Bank Statement Analysis Status

### Available States
| State | Description |
|-------|-------------|
| `PROCESSING` | Bank statement analysis is in processing |
| `SUCCESS` | Bank statement analysis failed and the bank account can be used for payin |
| `FAILED` | Bank statement analysis failed and the bank account cannot be used for payin |
...
| `REFUNDED` | The payout amount has been successfully reversed and returned to the source account (if applicable) |
...
| State | Description |
|-------|-------------|
| `PROCESSING` | The payin is currently being processed through our system |
| `SUCCESS` | The payin has been successfully completed and funds have been transferred to the beneficiary |
| `FAILED` | The payin has failed due to issues like insufficient funds or invalid account details |
| `REFUNDED` | The payin amount has been successfully reversed and returned to the source account (if applicable) |
