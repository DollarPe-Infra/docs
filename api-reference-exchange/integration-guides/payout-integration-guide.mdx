...
<Note>
**Before You Begin:**
- Ensure you have completed the [authentication setup](/api-reference-other/overview/authentication)
- Configure your [webhook endpoint](/api-reference-other/endpoint/webhook) for real-time updates
