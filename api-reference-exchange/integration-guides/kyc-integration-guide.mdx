...
Most verifications complete within 60 seconds to 120 minutes. If it's taking longer, check the status via API polling. For delays exceeding 3 hours, contact [support team](mailto:support@dollarpe.xyz).
</Accordion>
