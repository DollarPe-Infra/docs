...
<Note>
**Before You Begin:**
- Complete the [authentication setup](/api-reference-other/overview/authentication) for API access
...
Ensure you're using the correct base URL and your authentication headers are properly set up. Check our [authentication guide](/api-reference-other/overview/authentication) for details.
</Accordion>
